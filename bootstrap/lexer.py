...
class Lexer():
    ...
    def _add_tokens(self):
        ...
        self.lexer.add('EQ_REF', r"=")
        self.lexer.add('LT_REF', r"<")
        self.lexer.add('GT_REF', r">")
        self.lexer.add('LTEQ_REF', r"<=")
        self.lexer.add('GTEQ_REF', r">=")
        self.lexer.add('NOTEQ_REF', r"not=")
        # Modifiers
